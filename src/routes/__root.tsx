...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "RailFlow AI — Bharat Logistics OS" },
      { property: "og:description", content: "Intelligent rail–road freight optimization platform for India's logistics backbone." },
